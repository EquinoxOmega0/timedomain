...
class fastspecphoto_data(tablebaseclass):
    tablename = "fastspecphoto_data"
    createstatements = [ """
        CREATE TABLE IF NOT EXISTS "fastspecphoto_data" (
    ...
    def fill_table():   
        ...
        for survey in surveys:
            for target in targets:
                ...
                filename_spec = f"https://data.desi.lbl.gov/desi/spectro/fastspecfit/everest/catalogs/fastspec-everest-{survey}-{target}.fits"
                filename_photo = f"https://data.desi.lbl.gov/desi/spectro/fastspecfit/everest/catalogs/fastphot-everest-{survey}-{target}.fits"
                try:
                    ...
                    dat=hstack([dat0, dat1, dat2],uniq_col_name="TARGETID")
                except:
                    print(f"{filename} not found")
                    continue
                dat.convert_bytestring_to_unicode()
